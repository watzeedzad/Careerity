    ...
    <body>
        ...
        <!-- ===================================================================================================== -->
            ...
            <div class="tab" style="width:auto">
                ...
                <button class="tablinks btn-primary "  onclick="openCity(event, 'event')" id="defaultOpen" style="width:25%">Event</button>
                <button class="tablinks btn-primary " onclick="openCity(event, 'fullTime')"style="width:25%">FULL TIME</button>
                <button class="tablinks  btn btn-primary " onclick="openCity(event, 'partTime')"style="width:25%">PART TIME</button>
                <button class="tablinks btn btn-primary " onclick="openCity(event, 'homeJob')"style="width:25%">HOME</button>
            </div>
        ...
        <div class="row md-2">
            <div class="col-md-4 offset-md-2 ">
                <div class="card flex-md-row mb-4 box-shadow h-md-250">
                    ...
                    <img class="card-img-right flex-auto d-none d-xl-block" data-src="holder.js/200x250?theme=thumb" alt="Thumbnail [200x250]" style="width: 200px; height: 250px;" src="img/event/1.jpg" data-holder-rendered="true">
                </div>
            </div>
            <div class="col-md-4">
                <div class="card flex-md-row mb-4 box-shadow h-md-250">
                    ...
                    <img class="card-img-right flex-auto d-none d-xl-block" data-src="holder.js/200x250?theme=thumb" alt="Thumbnail [200x250]" src="img/event/2.jpg" data-holder-rendered="true" style="width: 200px; height: 250px;">
                </div>
            </div>
        </div>
        <div class="row md-2">
            <div class="col-md-4 offset-md-2">
                <div class="card flex-md-row mb-4 box-shadow h-md-250">
                    <div class="card-body d-flex flex-column align-items-start">
                        <h3 class="mb-0">
                            <a class="text-dark" href="EventDetail?eventId=3&userId=100001">ประกอบคอมพิวเตอร์ 2016</a>
                        </h3><br>
                        <img src="img/calendar.png" width="10%" height="15%"/>
                        <p class="card-text mb-auto">2018-03-04 - 2018-03-18</p>
                        <img src="img/placeholder.png" width="10%" height="15%"/>
                        <p class="card-text mb-auto">604/3 ถนน เพชรบุรี แขวง ถนนเพชรบุรี เขต ราชเทวี กรุงเทพมหานคร 10400</p>
                    </div>
                    <img class="card-img-right flex-auto d-none d-xl-block" data-src="holder.js/200x250?theme=thumb" alt="Thumbnail [200x250]" style="width: 200px; height: 250px;" src="img/event/3.jpg" data-holder-rendered="true">
                </div>
            </div>
            <div class="col-md-4">
                <div class="card flex-md-row mb-4 box-shadow h-md-250">
