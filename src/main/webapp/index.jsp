...
<html>
    ...
    <body>
        ...
        <div class="tab " style="width:50%">
            ...
            <button class="tablinks" onclick="openCity(event, 'event')" id="defaultOpen" style="width:25%">Event</button>
            <button class="tablinks" onclick="openCity(event, 'fullTime')"style="width:25%">FULL TIME</button>
            <button class="tablinks" onclick="openCity(event, 'partTime')"style="width:25%">PART TIME</button>
            <button class="tablinks" onclick="openCity(event, 'homeJob')"style="width:25%">HOME</button>
        </div></div>
                ...
                <div class="row md-2">
                    <div class="col-md-4 offset-md-2 ">
                        <div class="card flex-md-row mb-4 box-shadow h-md-250">
                            ...
                            <img class="card-img-right flex-auto d-none d-md-block" data-src="holder.js/200x250?theme=thumb" alt="Thumbnail [200x250]" style="width: 200px; height: 250px;" src="img/event/1.jpg" data-holder-rendered="true">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card flex-md-row mb-4 box-shadow h-md-250">
                            ...
                            <img class="card-img-right flex-auto d-none d-md-block" data-src="holder.js/200x250?theme=thumb" alt="Thumbnail [200x250]" src="img/event/2.jpg" data-holder-rendered="true" style="width: 200px; height: 250px;">
                        </div>
                    </div>
                </div>
              <div class="row md-2">
                    <div class="col-md-4 offset-md-2">
                        <div class="card flex-md-row mb-4 box-shadow h-md-250">
                            ...
                            <img class="card-img-right flex-auto d-none d-md-block" data-src="holder.js/200x250?theme=thumb" alt="Thumbnail [200x250]" style="width: 200px; height: 250px;" src="img/event/3.jpg" data-holder-rendered="true">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card flex-md-row mb-4 box-shadow h-md-250">
